  ...
  return (
    <>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 px-4 py-8 ">
        {events.map((event) => {
          const availableTickets = Math.max(0,event.ticketLimit - event.ticketsSold);
          const soldPercentage =event.ticketLimit > 0? (event.ticketsSold / event.ticketLimit) * 100: 0;
